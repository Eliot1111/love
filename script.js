...
// Обнуляем время для точного расчета дней
startDate.setHours(0, 0, 0, 0);

// Целевая дата - 25 января
const targetDate = new Date();
targetDate.setMonth(0); // Январь (месяцы начинаются с 0)
targetDate.setDate(25);
targetDate.setHours(0, 0, 0, 0);

// Если 25 января уже прошло в этом году, берем следующий год
